      ...
      body: Column(
        children: <Widget>[
          Expanded(
            ...
            child: Stack(
              children: <Widget>[
                Image.asset(game_sekiro, fit: BoxFit.fitHeight, height: 400,),
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(text: "\n"),
                                TextSpan(text: "Sekiro: Shadows Dies Twice", style: newGameNameTextStyle)
                              ]
                            ),
                          ),
                          SizedBox(height: 20,),
                            ...
                            child: RichText(
                              text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(text: '\n'),
                                    TextSpan(text: "${lastPlayedGames[0].hoursPlayed} hours played", style: bodyTextStyle.copyWith(color: Colors.white,
